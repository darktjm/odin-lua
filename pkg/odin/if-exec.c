      ...
      if (DestFilHdr != NIL) {
         ...
         if (!Abort) {
            ...
            if (!Abort) {
               ...
               Set_Status(DestFilHdr, STAT_Busy);
            }
...
static tp_Status Get_ExecStatus(tp_FilHdr FilHdr, tp_Job Job)
{
   tp_Status Status;
...
void Local_Job_Done(tp_JobID JobID, boolean Abort)
{
